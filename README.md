...
- **Editor con vista previa en \(\LaTeX\)**: escribe el integrando en un área dedicada, visualiza al instante cómo se renderiza y complementa la captura con el teclado contextual de números, operadores, funciones, trigonometría y ayudas de método.
...
- Aprovecha el editor con vista previa en \(\LaTeX\): puedes teclear expresiones como `\frac{2x}{x^2+1}`, observar cómo se mostrarán y apoyarte en el teclado integrado para insertar fracciones, raíces, trigonometría y símbolos auxiliares.
